...
/////////////////////////////////////////////////////////////////////////////
//	Wdm2AddDevice					Add device routine
//	Wdm2Pnp							PNP IRP dispatcher
...
#define INITGUID // initialize WDM2_GUID in this module
						...
						IN PDEVICE_OBJECT pdo)
{
	...
	status = IoRegisterDeviceInterface( pdo, &WDM2_GUID, NULL, &dx->ifSymLinkName);
	if( !NT_SUCCESS(status))
	{
		IoDeleteDevice(fdo);
		return status;
