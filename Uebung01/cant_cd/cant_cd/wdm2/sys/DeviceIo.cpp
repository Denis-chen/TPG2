...
//bool DisableDeviceInterrupts( IN PWDM2_DEVICE_EXTENSION dx);
//bool EnableDeviceInterrupts( IN PWDM2_DEVICE_EXTENSION dx);
//BOOLEAN InterruptHandler(IN PKINTERRUPT Interrupt, IN PWDM2_DEVICE_EXTENSION fdo);
...
/////////////////////////////////////////////////////////////////////////////
/*
void WriteByte( IN PWDM2_DEVICE_EXTENSION dx, IN UCHAR byte, IN ULONG offset)
{
	if (dx->PortInIOSpace)
...
BOOLEAN InterruptHandler(IN PKINTERRUPT Interrupt, IN PWDM2_DEVICE_EXTENSION dx)
{
