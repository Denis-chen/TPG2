...
NTSTATUS RetrieveResources(IN PWDM3_DEVICE_EXTENSION dx,IN PCM_RESOURCE_LIST AllocatedResourcesTranslated);
//bool DisableDeviceInterrupts( IN PWDM3_DEVICE_EXTENSION dx);
//bool EnableDeviceInterrupts( IN PWDM3_DEVICE_EXTENSION dx);
//BOOLEAN InterruptHandler(IN PKINTERRUPT Interrupt, IN PWDM3_DEVICE_EXTENSION fdo);

/////////////////////////////////////////////////////////////////////////////
//	StartDevice:	Start the device

NTSTATUS StartDevice( IN PWDM3_DEVICE_EXTENSION dx, IN PCM_RESOURCE_LIST AllocatedResourcesTranslated)
{
	if( dx->GotResources)
...
*/
	...
	// Power up device
	SetPowerState( dx, PowerDeviceD0);
...
/////////////////////////////////////////////////////////////////////////////
/*
void WriteByte( IN PWDM3_DEVICE_EXTENSION dx, IN UCHAR byte, IN ULONG offset)
{
	if (dx->PortInIOSpace)
...
BOOLEAN InterruptHandler(IN PKINTERRUPT Interrupt, IN PWDM3_DEVICE_EXTENSION dx)
{
