...
/////////////////////////////////////////////////////////////////////////////
//	Wdm3Create			Handle Create/Open file IRP
//	Wdm3Close			Handle Close file IRPs
//	Wdm3Read			Handle Read IRPs
//	Wdm3Write			Handle Write IRPs
//	Wdm3DeviceControl	Handle DeviceIoControl IRPs
/////////////////////////////////////////////////////////////////////////////
//	Version history
...
NTSTATUS PowerUpDevice( IN PWDM3_DEVICE_EXTENSION dx);
					...
					IN PIRP Irp)
{
	...
	Wdm3EventMessage("CreateFile");
	Wdm3FireEvent( fdo, L"Wdm3Create called");
					...
					IN PIRP Irp)
{
	...
	NTSTATUS status = PowerUpDevice(dx);
